export const pt = {
  ...
  vacation: {
    hero: {
      title: "Férias da alegria",
      text: "Criamos um ambiente para crianças aproveitarem as férias em um local seguro e propício",
    },
    howItWorks: {
      title: "Como Funciona?",
  ...
  easter: {
    hero: {
      title: "Páscoa do bem e da esperança",
      text: "Uma festa feita para celebrar a páscoa dentro da comunidade para as crianças",
    },
    howItWorks: {
      title: "Como Funciona?",
  ...
  volunteers: {
    ...
    formSection: {
      ...
      subtitle: "Venha fazer parte do nosso time que transforma!",
    ...
    positions: [
      ...
      },
      {
        ...
        body: "Identificar e engajar novos doadores, além de fortalecer o relacionamento com parceiros e colaboradores recorrentes.",
      },
      {
